...
\begin{document}
	\begin{sloppypar} %latex中一行文字出现溢出问题的解决方法
		...
		\mySection{}{About This Book}{content/chapter0/0.tex}
		\mySubsection{}{What You Should Know Before Reading This Book}{content/chapter0/1.tex}		
		\mySubsection{}{Overall Structure of the Book}{content/chapter0/2.tex}		
		\mySubsection{}{How to Read This Book}{content/chapter0/3.tex}		
		\mySubsection{}{The Way I Implement}{content/chapter0/4.tex}		
		\mySubsection{}{The C++ Standards}{content/chapter0/5.tex}		
		\mySubsection{}{Example Code and Additional Information}{content/chapter0/6.tex}
		\mySubsection{}{Feedback}{content/chapter0/7.tex}
		\newpage
		
		\mySection{第1章}{Comparisons and Operator <=>}{content/chapter1/0.tex}	
		\mySubsection{1.1.}{Motivation for Operator<=>}{content/chapter1/1.tex}
		\mySubsection{1.2.}{Defining and Using Comparisons}{content/chapter1/2.tex}
		\mySubsection{1.3.}{Defining operator<=> and operator==}{content/chapter1/3.tex}
		\mySubsection{1.4.}{Overload Resolution with Rewritten Expressions}{content/chapter1/4.tex}
		\mySubsection{1.5.}{Using Operator <=> in Generic Code}{content/chapter1/5.tex}
		\mySubsection{1.6.}{Compatibility Issues with the Comparison Operators}{content/chapter1/6.tex}
		\mySubsection{1.7.}{Afternotes}{content/chapter1/7.tex}
		\newpage
		...
		\subfile{content/chapter18/0.tex}
		...
		\subfile{content/chapter25/4.tex}
