...
\begin{document}
	\begin{sloppypar} %latex中一行文字出现溢出问题的解决方法
		...
		\mySubsection{9.2.}{Span有害}{content/chapter9/2.tex}
		...
		\mySubsection{11.5.}{在实践中使用Chrono扩展}{content/chapter11/5.tex}
