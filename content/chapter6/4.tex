...
\mySubsubsection{6.4.1}{Lifetime Dependencies Between Views and Their Ranges}
...
\mySubsubsection{6.4.2}{Views with Write Access}
...
\mySubsubsection{6.4.3}{Views on Ranges That Change}
...
\mySubsubsection{6.4.4}{Copying Views Might Change Behavior}
...
\mySamllsection{Write Access with Filter Views}
