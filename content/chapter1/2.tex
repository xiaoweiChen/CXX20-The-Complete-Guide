...
\mySubsubsection{1.2.1}{Using Operator<=>}
...
\mySubsubsection{1.2.2}{Comparison Category Types}
...
\mySamllsection{Comparison Categories}
...
\mySamllsection{Comparison Category Types in the Standard Library}
...
\mySubsubsection{1.2.3}{Using Comparison Categories with operator<=>}
...
\mySubsubsection{1.2.4}{Calling Operator <=> Directly}
...
\mySubsubsection{1.2.5}{Dealing with Multiple Ordering Criteria}
