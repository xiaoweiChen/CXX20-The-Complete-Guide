...
\mySamllsection{std::ranges::range vs. std::ranges::view}
...
\mySamllsection{std::invocable vs. std::regular\_invocable}
...
\mySamllsection{std::weakly\_incrementable vs. std::incrementable}
