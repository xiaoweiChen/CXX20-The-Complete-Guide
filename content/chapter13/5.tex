锁存器和栅栏最早是由Alasdair Mackintosh在\url{http://wg21.link/n3600}中提出的。最终接受的提案是由Bryce Adelstein Lelbach、Olivier Giroux、JF Bastien、Detlef Vollmann和David Olsen在\url{http://wg21.link/p1135r6}上制定的。
